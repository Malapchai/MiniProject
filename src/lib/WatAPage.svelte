<script>
	...
	import { fetchRandomChiChiA } from '../services/chichiService'; // Service to fetch random Chi-Chi from A collection
	...
	async function fetchChiChiData() {
		loading = true;
		chiChiData = await fetchRandomChiChiA();
...
<div class="wat-page">
	<div class="wat-content">
		...
		<h1 class="title">วัดระฆังโฆสิตาราม วรมหาวิหาร</h1>
